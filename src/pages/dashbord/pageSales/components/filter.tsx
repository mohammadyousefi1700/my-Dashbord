...
import { setFiltersTypePageSales } from "./type";

function FiltersPageSales(props: setFiltersTypePageSales) {
    ...
    <div className="w-full ">
      <div className="flex w-full my-4 gap-x-3">
        <BaseInput
          ...
          defaultValue={filters?.CustomerName || undefined}
        ...
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="p-1 text-blue-700 border-2 border-blue-700 rounded-lg cursor-pointer w-9"
        >
          <path
            strokeLinecap="round"
...
export default FiltersPageSales;
